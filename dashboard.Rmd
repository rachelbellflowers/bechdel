---
title: "Bechdel Pass Rates of Movies Listed on IMDB"
output: 
...
library(pacman)
p_load(data.table, tidyverse, DT, reactable, flexdashboard, htmlwidgets, bslib, lubridate, plotly)
...
```{r}
valueBox(1559, caption = "Number of Movies", icon="ion-videocamera")
